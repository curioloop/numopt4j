...
interface Dlarf {
    ...
    static void dlarf(BLAS.Side side, int m, int n,
                      ...
                      double[] C, int cOff, int ldc, double[] work) {
        dlarf(side, m, n, v, vOff, incv, tau, C, cOff, ldc, work, 0);
    }
    ...
    static void dlarf(BLAS.Side side, int m, int n,
        ...
        if (applyLeft) {
            ...
            Dgemv.dgemv(BLAS.Transpose.Trans, lastv + 1, lastc + 1, 1.0, 
                        C, cOff, ldc, 
                        v, vOff, incv, 
                        0.0, work, workOff, 1);
            ...
            Dgemv.dgemv(BLAS.Transpose.NoTrans, lastc + 1, lastv + 1, 1.0,
                        C, cOff, ldc,
                        v, vOff, incv,
                        0.0, work, workOff, 1);
